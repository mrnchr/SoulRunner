  ...
  public class KelliAnimator : PlayerAnimator<KelliAnimType>
  {
    ...
    private void Awake()
    {
      ...
      _animator
        ...
        .AddTransition(KelliAnimType.JumpIdle, KelliAnimType.JumpLand, () => !IsJump && !IsFall && !IsCrouch && !IsAttack)
        ...
        .AddTransition(KelliAnimType.JumpLand, KelliAnimType.Crouch, () => IsCrouch)
        ...
        .AddTransition(KelliAnimType.JumpIdle, KelliAnimType.JumpFireStart, () => IsAttack)
