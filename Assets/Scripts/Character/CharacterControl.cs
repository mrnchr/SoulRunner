...
//             LevelObsolete.onPauseStateChangedEvent += pauseStateChangedHandler;
//             User.onDeathEvent += deathEventHandler;
//             _groundChecker.onGroundEnter += groundTriggerEnterHandler;
//             _groundChecker.onGroundExit += groundTriggerExitHandler;
...
//         {
//             Vector3 moveVector = _rb.velocity;
//             moveVector.x = dir * _moveSpeed;
//             _rb.velocity = moveVector;
//             _anim.moveVector = moveVector;
//         }
//
...
//             User.onDeathEvent -= deathEventHandler;
//             _groundChecker.onGroundEnter -= groundTriggerEnterHandler;
//             _groundChecker.onGroundEnter -= groundTriggerExitHandler;
//             _ledgeChecker.onTriggerEnter -= ledgeTriggerEnterHandler;
//             _ledgeChecker.onTriggerExit -= ledgeTriggerExitHandler;
//             _input.onMove -= Move;
//         }
...
//                 transform.localScale = _moveVector.x switch
//                 {
//                     < 0 when transform.localScale.x != -1 => new Vector3(-1, 1, 1),
//                     > 0 when transform.localScale.x != 1  => new Vector3(1, 1, 1),
...
//         }
//
//         private void LateUpdateObsolete() {
//             if (LevelObsolete.isPaused || _isDead) {
//                 return;
//             }
//             
//             ProcessInput();
...
//                 _moveVector.y -= 20 * dt;
//             }
//             _projectiles.ForEach(x => x.step(dt));
//         }
//
